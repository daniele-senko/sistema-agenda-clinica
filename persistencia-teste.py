...
def test_agenda_repository():
    ...
    paciente = Paciente(id=2, nome="Teste Paciente", data_nascimento="1990-01-01", telefone="123456789")
    medico = Medico(id=1, nome="Teste Médico", especialidade="Cardiologia", telefone="987654321")
